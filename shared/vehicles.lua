...
local Vehicles = {
    ...
    --- Custom Police
    { model = 'segway',           name = 'Segway',                     brand = 'Segway',          price = 5000,    category = 'mororcycles',    type = 'automobile', shop = 'none' },
    ...
    { model = 'rr20supra',        name = '2021 Supra GR',              brand = 'Toyota',          price = 26000,   category = 'donate',         type = 'automobile', shop = 'none' },
    { model = 'rr21shelbystreet', name = '2021 F-150 Shelby',          brand = 'Ford',            price = 26000,   category = 'donate',         type = 'automobile', shop = 'none' },

...
QBShared.Weapons = {
	...
	-- weapon pack
	[`weapon_broomcmg`] = { name = 'weapon_broomcmg', label = 'Broom', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_mjlonircmg`] = { name = 'weapon_mjlonircmg', label = 'Mjlonir', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_chainsaw`] = { name = 'weapon_chainsaw', label = 'Chainsaw', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_trafficsigncmg`] = { name = 'weapon_trafficsigncmg', label = 'Traffic Sign', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_toiletbrushcmg`] = { name = 'weapon_toiletbrushcmg', label = 'Toilet Brush', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_kitchenknifecmg`] = { name = 'weapon_kitchenknifecmg', label = 'Kitchen Knife', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_guitarcmg`] = { name = 'weapon_guitarcmg', label = 'Guitar', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_hamaxehamcmg`] = { name = 'weapon_hamaxehamcmg', label = 'Ham Axe', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_cricketbatcmg`] = { name = 'weapon_cricketbatcmg', label = 'Cricket Bat', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_cleavercmg`] = { name = 'weapon_cleavercmg', label = 'Cleaver', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_butterflycmg`] = { name = 'weapon_butterflycmg', label = 'Butterfly Knife', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_fireaxecmg`] = { name = 'weapon_fireaxecmg', label = 'Fire Axe', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_kickass`] = { name = 'weapon_kickass', label = 'Kickass Stick', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_baseballbat`] = { name = 'weapon_baseballbat', label = 'Marucci AP5 Baseball Bat', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_nailbat`] = { name = 'weapon_nailbat', label = 'Lucille', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_longsword`] = { name = 'weapon_longsword', label = 'Medieval Longsword', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_stalker`] = { name = 'weapon_stalker', label = 'Stalker Knife', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_axe`] = { name = 'weapon_axe', label = 'COD Axe', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_awcmg`] = { name = 'weapon_awcmg', label = 'AW Combat Knife', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_hawk`] = { name = 'weapon_hawk', label = 'Tomahawk', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_sword`] = { name = 'weapon_sword', label = 'Corvo Attano Sword', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_pilum`] = { name = 'weapon_pilum', label = 'Roman Pilum', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_blade`] = { name = 'weapon_blade', label = 'Captain America Shield', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_brick`] = { name = 'weapon_brick', label = 'Brick', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_wuxiafan`] = { name = 'weapon_wuxiafan', label = 'Wu Xia Fan', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_sweettooth`] = { name = 'weapon_sweettooth', label = 'Sweet Tooths Machete', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_pony`] = { name = 'weapon_pony', label = 'My Little Pony Twilight', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_shitstick`] = { name = 'weapon_shitstick', label = 'Shit Stick', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_ronin`] = { name = 'weapon_ronin', label = 'Ronin Sword', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_stormbreaker`] = { name = 'weapon_stormbreaker', label = 'Stormbreaker', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_crutch`] = { name = 'weapon_crutch', label = 'Crutch', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_kirito`] = { name = 'weapon_kirito', label = 'Kiritos Sword', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_horsebat`] = { name = 'weapon_horsebat', label = 'Pony Stick', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_daedric`] = { name = 'weapon_daedric', label = 'Daedric Sword', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_needle`] = { name = 'weapon_needle', label = 'Needle', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_lightsaber`] = { name = 'weapon_lightsaber', label = 'Lightsaber', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_dildocmg`] = { name = 'weapon_dildocmg', label = 'Dildo', caliber = nil, weapontype = 'Melee', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
	[`weapon_glockcmg`] = { name = 'weapon_glockcmg', label = 'Glock CMG', caliber = '9x19mm Parabellum',  weapontype = 'Pistol', ammotype = 'AMMO_PISTOL', damagereason = 'Pistoled / Blasted / Plugged / Bust a cap in' },
	[`weapon_usp45`] = { name = 'weapon_usp45', label = 'Glock USP45', caliber = '9x19mm Parabellum',  weapontype = 'Pistol', ammotype = 'AMMO_PISTOL', damagereason = 'Pistoled / Blasted / Plugged / Bust a cap in' },
	[`weapon_p80`] = { name = 'weapon_p80', label = 'Glock P80', caliber = '9x19mm Parabellum',  weapontype = 'Pistol', ammotype = 'AMMO_PISTOL', damagereason = 'Pistoled / Blasted / Plugged / Bust a cap in' },
